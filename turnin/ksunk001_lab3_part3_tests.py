...
tests = [ {'description': 'Level 1-2 with seatbelt sign',
    ...
    {'description': 'Level 10-11-12 with seatbelt sign',
    'steps': [ {'inputs': [('PINA', 0x3B)],'iterations': 5}],
    'expected': [('PORTC',0xBE)],
    },
    {'description': 'Level 13-14-15 with no sign',
